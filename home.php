...
<body>
    ...
    <div class="logout-button">
        <a href="index.php">
            <img src="images/icon_desconect2.png" alt="Logout">
        </a>
    </div>
    ...
    <div class="card card-custom text-center bg-white">
        ...
        <div class="d-grid gap-2 mb-2">
            <button onclick="window.location.href='configuracoes.php'" class="btn btn-outline-primary">Configurações</button>
            <button onclick="window.location.href='relatorio_execucao.php'" class="btn btn-outline-primary">Relatório de Execução</button>
        </div>
    </div>
