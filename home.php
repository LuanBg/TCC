      ...
      <div class="price__grid">
        <div class="price__card">
          <div class="price__card__content">
            <h4>DOWNLOARD</h4>
            <h3>FIST</h3> 
            <p><i class="ri-arrow-down-circle-fill"></i></i>METODO PRIMÁRIO</p>
            
          </div>
          <button class="btn price__btn">ínicia</button> 
        </div>
      </div>
      ...
      <div class="price__grid">
        <div class="price__card">
          <div class="price__card__content">
            <h4>DOWNLOARD</h4>
            <h3>DANFE</h3> 
            <p><i class="ri-arrow-down-circle-fill"></i></i>METODO SECUNDÁRIO</p>
