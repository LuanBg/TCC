        ...
        <div class="content">
            ...
            <div class="card shadow-sm mb-5">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="images/logo.png" alt="Imagem do Projeto" class="img-fluid rounded-3">
                        </div>
                        <div class="col-md-6">
                            ...
                            Com isso, a equipe pode se concentrar em atividades de maior valor agregado, reduzindo o tempo de entrega.</p>
                        </div>
                    </div>
                </div>
            </div>
