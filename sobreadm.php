...
<head>
    ...
    <title>Sobre / Bomfim Contabilidade</title>
...
<body>
    <div class="user-info">
        ...
        <div class="actions">
            <div class="back">
                <img src="images/voltar2-removebg-preview.png" alt="Back">
                <a href="configuracoesadm.php">Voltar</a>
            </div>
            <div class="logout">
                <img src="images/desconectar-removebg-preview.png" alt="Logout">
    ...
    <div class="content">
        ...
        <h2 style="text-align:center; margin-bottom:20px;">Nosso Projeto</h2>
